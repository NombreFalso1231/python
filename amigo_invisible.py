...
def presupuesto(lista_presupuesto):   # Introducir el presupuesto acordado.
	while True:
		try:
...
def cambio_presupuesto(lista_presupuesto):   # Introducir otro presupuesto y borrar el antiguo
...
# Hacer el sorteo de forma aleatoria. Primero se baraja lista_jugadores de forma aleatoria y despues se empareja a cada uno con el anterior.
